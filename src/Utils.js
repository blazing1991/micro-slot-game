...
export class Utils {
    ...
    static scaleToWindow(canvas, backgroundColor) {
        ...
        if (canvas.offsetWidth > canvas.offsetHeight) {
            if (canvas.offsetWidth * scale < window.visualViewport.width) {
                center = "horizontally";
            } else {
                center = "vertically";
            }
        } else {
            if (canvas.offsetHeight * scale < window.visualViewport.height) {
                center = "vertically";
            } else {
                center = "horizontally";
            }
        ...
        if (center === "horizontally") {
            margin = (window.visualViewport.width - canvas.offsetWidth * scale) / 2;
        ...
        if (center === "vertically") {
            margin = (window.visualViewport.height - canvas.offsetHeight * scale) / 2;
